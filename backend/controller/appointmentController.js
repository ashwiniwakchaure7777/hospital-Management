...
const postAppointment = catchAsyncErrors(async (req,res,next)=>{
    const {firstName,lastName,email,phone,nic,dob,gender,appointment_date,department,doctor_firstName,doctor_lastName,
    hasVisited,
    address} = req.body;
...
const getAllAppointment = catchAsyncErrors( async (req,res,nex)=>{
...
export {getAllAppointment, updateAppointmentStatus, deleteAppointment};